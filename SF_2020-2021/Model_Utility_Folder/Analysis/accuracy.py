...
file = open("SF_2020-2021/Model_Utility_Folder/Analysis/OutputTxts/B_K100.txt").read()
...
df.to_csv(os.path.join("SF_2020-2021/Model_Utility_Folder/Analysis", "B_K100.csv"), sep=",", index=False)
