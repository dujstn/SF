...
usablePoints = pd.read_csv("SF_2020-2021/Data/Usables.csv")
usableGeometry = [Point(xy) for xy in zip(usablePoints["Longitude"], usablePoints["Latitude"])]

unusableEconPoints = pd.read_csv("SF_2020-2021/Data/UnusableEcon.csv")
unusableEconGeometry = [Point(xy) for xy in zip(
    unusableEconPoints["Longitude"], unusableEconPoints["Latitude"])]

unusableInsoPoints = pd.read_csv("SF_2020-2021/Data/UnusableInso.csv")
...
usableGeo.plot(ax=ax, markersize=0.5, color="blue")
unusableEconGeo.plot(ax=ax, markersize=0.5, color="red")
unusableInsoGeo.plot(ax=ax, markersize=0.5, color="green")
plt.show()
