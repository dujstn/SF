...
# Main function
#def main():
train = pd.read_csv("SF_2020-2021/Data/SOUTHCAN_TRAIN.csv")
eval2 = pd.read_csv("SF_2020-2021/Data/SOUTHCAN_EVAL.csv")
...
output = knn(trainList, evalList, k=10, distanceFN=euclidDis, choiceFN=mean)
